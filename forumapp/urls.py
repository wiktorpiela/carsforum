...
urlpatterns = [
    ...
    path("details/<int:questionID>/like-question/<str:pageLocation>/", views.like_question, name="like_question"),
    path("like-answer/<int:answerID>/<str:pageLocation>/", views.like_answer, name="like_answer"),
